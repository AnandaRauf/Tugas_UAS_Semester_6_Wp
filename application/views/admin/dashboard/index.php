          ...
          <section class="col-lg-7 connectedSortable">
              ...
              <div class="card-footer">
                <form action="#" method="post">
                  <div class="input-group">
                    <input type="text" name="message" placeholder="<?= trans('type_message') ?> ..." class="form-control">
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <button type="button" class="btn btn-info float-right"><i class="fa fa-plus"></i> <?= trans('add_item') ?></button>
              </div>
            </div>
            <!-- /.card -->
          </section>
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  <div class="col-4 text-center">
                    ...
                    <div class="text-white"><?= trans('visitors') ?></div>
                  </div>
                  <!-- ./col -->
                  <div class="col-4 text-center">
                    <div id="sparkline-2"></div>
                    <div class="text-white"><?= trans('online') ?></div>
                  </div>
                  <!-- ./col -->
                  <div class="col-4 text-center">
                    <div id="sparkline-3"></div>
                    <div class="text-white"><?= trans('sales') ?></div>
                  </div>
                  <!-- ./col -->
                </div>
                <!-- /.row -->
