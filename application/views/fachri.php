...
<html lang="en" id="home">
  ...
  <body>
    ...
    <div class="jumbotron text-center">
      <img src="assets/img/fachri.jpeg" class="img-circle">
      <h1>Fachri Affif Valensyah</h1>
  ...
  <section class="about" id="about">
    <div class="container">
      ...
      <div class="row">
        ...
        <blockquote>
          <p>Perkenalkan saya Fachri Affif Valensyah,Mahasiswa Teknologi Informasi semester 6 di Universitas Bina Sarana Informatika.</p></blockquote>
        </div>
        <div class="col-sm-5">
        <blockquote>
          <p>
            Apabila Ibu/Bapak Perusahaan mencari seorang kandidat baru untuk Perusahaan dibidang mana saja, dan untuk menjalin kerjasama bisa hubungi saya dengan mengisi formulir kontak. <br><br>Terima kasih.</br></br>Hormat saya,<br>Fachri Affif Valensyah<br>
          </p>  
        </blockquote>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <!-- Thumbnail Gambar -->
      ...
      <div class="col-sm-4">
        <a href="https//www.instagram.com/justinx_chiro" class="thumbnail">
